...
class ActiveLearner:
    ...
    def init_tree(self, initial_belief):
        """Initialize belief tree from a list of possible initial latent states."""
        self.belief_tree = BeliefTree(self.world_model, initial_belief, self.num_model_particles)
    ...
    def rollout_policy(self, policy, n_rollouts=1):
        ...
        last_entropy = node.model_entropy()
        infogains = []
        while True:
            ...
            new_entropy = node.model_entropy()
